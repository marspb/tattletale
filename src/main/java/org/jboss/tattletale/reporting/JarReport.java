...
public class JarReport extends ArchiveReport {
	...
	/**
	 * The level of depth from the main output directory that this jar report
	 * would sit
	 */
	private int depth;
	 ...
	 *            The archive
	 * @param depth
	 *            The level of depth at which this report would lie
	 */
	...
	/**
	 * returns a Jar report specific writer. Jar reports don't use a index.html
	 * but a html per archive.
	 *
	...
	public void writeHtmlBodyContent(BufferedWriter bw) throws IOException {
		...
		if (ClassFile.JAVA_8 == archive.getVersion()) {
			bw.write("Java 8");
		} else if (ClassFile.JAVA_7 == archive.getVersion()) {
			bw.write("Java 7");
		} else if (ClassFile.JAVA_6 == archive.getVersion()) {
			bw.write("Java 6");
	...
	public void writeHtmlBodyHeader(BufferedWriter bw) throws IOException {
		...
		bw.write("<a href=\"" + getSubpathToArchive() + "/index.html\">Main</a>" + Dump.newLine());
		bw.write("<p>" + Dump.newLine());
	}

	private String getSubpathToArchive() {
		Archive a = this.archive;
		String subpathToArchive = "..";
		while ((a = a.getParentArchive()) != null) {
			subpathToArchive = "../" + subpathToArchive;
		}
